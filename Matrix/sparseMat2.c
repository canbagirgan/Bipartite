...
#ifdef ISEND
#define _SEND(buff, req, tag) MPI_Isend(&(buff->data[base][0]), range * buff->feature_size, MPI_DOUBLE, k, tag, MPI_COMM_WORLD, req)
#else
#define _SEND(buff, req, tag) MPI_Send(&(buff->data[base][0]), range * buff->feature_size, MPI_DOUBLE, k, tag, MPI_COMM_WORLD)
#endif

#ifdef IRECV
#define _RECV(buff, req, tag) MPI_Irecv(&(buff->data[base][0]), range * buff->feature_size, MPI_DOUBLE, k, tag, MPI_COMM_WORLD, req)
#else
#define _RECV(buff, req, tag) MPI_Recv(&(buff->data[base][0]), range * buff->feature_size, MPI_DOUBLE, k, tag, MPI_COMM_WORLD)
#endif
